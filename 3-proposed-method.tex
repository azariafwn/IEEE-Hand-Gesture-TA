...
\begin{enumerate}
    ...
    \item Deep Learning Model (LSTM): A custom Long Short-Term Memory (LSTM) network is designed to classify dynamic gestures. The architecture consists of three LSTM layers (64, 128, and 64 units) followed by Dense layers. The model is trained on a dataset of 10 dynamic gestures, divided into Selection Gestures (pointing 1-4 fingers) and Action Gestures (Open \& Close palm).
