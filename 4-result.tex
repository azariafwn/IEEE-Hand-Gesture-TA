...
The LSTM model was trained on a dataset of 10 dynamic gestures collected from 8 subjects. Fig. \ref{fig:training_accuracy} illustrates the training and validation accuracy over 35 epochs, while Fig. \ref{fig:training_loss} shows the corresponding loss curves.
\begin{enumerate}
