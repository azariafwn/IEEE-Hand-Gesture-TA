...
\begin{enumerate}
    ...
    \item Final Accuracy: The baseline Keras model achieved a validation accuracy of 99\%, demonstrating excellent generalization without significant overfitting, as indicated by the minimal gap between training and validation loss in Fig. \ref{fig:training_loss}.
\end{enumerate}
