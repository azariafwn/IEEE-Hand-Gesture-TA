...
To effectively learn the temporal dependencies inherent in dynamic hand movements, this study employs a Stacked Long Short-Term Memory (LSTM) network. LSTM are explicitly designed to overcome the vanishing gradient problem in standard recurrent networks, making them highly effective for processing the sequentially buffered $(30, 63)$ spatial feature tensors \cite{sengupta2020review}. The use of a stacked architecture allows the model to build a hierarchical representation of the temporal data, where deeper layers capture higher-level abstractions of the gesture dynamics \cite{yu2019review}. The complete layer-by-layer configuration of the proposed network is detailed in Table \ref{tab:model_architecture}.
